...
?>
      ...
      <div class="index-semi-nav-bar">
        <div class="index-semi-nav-bar-left">
          <div class="browse-container">
            ...
            <a href="./adminApproveList.php">Phê duyệt</a>
            <a href="./listProductAdmin.php" style='color: rgb(18, 18, 18)'>Ds sản phẩm</a>
          </div>
    ...
    <div class="wishlist-main">
      <table class="wishlist-ul-item table-list-admin-product">
...
?>
  ...
  <script src="./js/handleListProductAdmin.js"></script>
</body>
